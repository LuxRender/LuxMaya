...
#            nAttr.setHidden( True )
            ...
            blenderWoodTexture.tex1 = blenderWoodTexture.makeColor("tex1", "t1", defaultR = 0.0, defaultG = 0.0, defaultB = 0.0)
            blenderWoodTexture.tex2 = blenderWoodTexture.makeColor("tex2", "t2")
