...
#            nAttr.setHidden( True )
            ...
            blenderCloudsTexture.tex1 = blenderCloudsTexture.makeColor("tex1", "t1", defaultR = 0.0, defaultG = 0.0, defaultB = 0.0)
            blenderCloudsTexture.tex2 = blenderCloudsTexture.makeColor("tex2", "t2")
