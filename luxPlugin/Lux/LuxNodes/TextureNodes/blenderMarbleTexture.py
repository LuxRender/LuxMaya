...
#            nAttr.setHidden( True )
            ...
            blenderMarbleTexture.tex1 = blenderMarbleTexture.makeColor("tex1", "t1", defaultR = 0.0, defaultG = 0.0, defaultB = 0.0)
            blenderMarbleTexture.tex2 = blenderMarbleTexture.makeColor("tex2", "t2")
